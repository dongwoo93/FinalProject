				...
				<div class="row mt-2">
					<c:forEach var="follow" items="${result}" varStatus="status">
						...
						<c:choose>
							...
							<h5 class="text-center mt-1" onclick="showModal('${sessionScope.loginId}', '${follow.targetId}', this)" style="background-color: rgba(255, 255, 255, 0.15);color:#4f70ce;font-weight:bold;font-family: NANUMBARUNPENR !important;" id="cancelFollow${status.index}">팔로잉</h5>
							<h5 class="text-center mt-1" onclick="follow('${sessionScope.loginId}', '${follow.targetId}', this)"
...
<%-- 										id="follow${status.index}">팔로우 <i class="fas fa-plus"></i></button> --%>
							...
							<h5 class="text-center mt-1" onclick="showModal('${sessionScope.loginId}', '${follow.targetId}', this)" style="display:none; background-color: rgba(255, 255, 255, 0.15);color:#4f70ce;font-weight:bold;font-family: NANUMBARUNPENR !important;" id="cancelFollow${status.index}">팔로잉</h5>
							<h5 class="text-center mt-1" onclick="follow('${sessionScope.loginId}', '${follow.targetId}', this)"
...
<%-- 										id="follow${status.index}">팔로우 <i class="fas fa-plus"></i></button> --%>
							...
							<h5 class="text-center mt-1" onclick="showModal('${sessionScope.loginId}', '${follow.id}', this)" style="background-color: rgba(255, 255, 255, 0.15);color:#4f70ce;font-weight:bold;font-family: NANUMBARUNPENR !important;" id="cancelFollow${status.index}">팔로잉</h5>
							<h5 class="text-center mt-1" onclick="follow('${sessionScope.loginId}', '${follower.id}', this)"
										id="follow${status.index}" style="display:none;color:#4f70ce;font-weight:bold;font-family: NANUMBARUNPENR !important;">팔로우 <i class="fas fa-plus"></i></h5>
...
<%-- 										id="follow${status.index}">팔로우 <i class="fas fa-plus"></i></button> --%>
								...
								<h5 class="text-center mt-1" onclick="showModal('${sessionScope.loginId}', '${follow.id}', this)" style="display:none; background-color: rgba(255, 255, 255, 0.15);color:#4f70ce;font-weight:bold;font-family: NANUMBARUNPENR !important;" id="cancelFollow${status.index}">팔로잉</h5>
								<h5 class="text-center mt-1" onclick="follow('${sessionScope.loginId}', '${follower.id}', this)"
										id="follow${status.index}" style="color:#4f70ce;font-weight:bold;font-family: NANUMBARUNPENR !important;">팔로우 <i class="fas fa-plus"></i></h5>
