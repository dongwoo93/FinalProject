...
$(document).on('keypress',"div[id*='comment'].insertSpecialField",function(event){   
							...
							<c:choose>
								<c:when test="${tmp.thisArticleForAd eq 1}">
									<a class="mt-1 idtxt" id="id"
										...
										style="color: #4f70ce; font-weight: bold;">${ membersNick[status.index] }<br>
								...
								<c:otherwise>
									<a class="mt-1 idtxt" id="id"
										href="board.bo?id=${tmp.id}&cat=1"
										style="color: #12bbad; font-weight: bold;">${tmp.id}<br>Dangsan.South
										Korea
									</a>
								</c:otherwise>
							</c:choose>
							...
							<div id="contcenter" class="mt-2 mx-3 pb-2">
								...
								<div class="navbar-nav">
									<a class="ml-1 idtxt" id="con${tmp.board_seq}"
										href="board.bo?id=${tmp.id}&cat=1"
										style="font-weight: bold; font-size: 14px; color: #12bbad;">${tmp.id}</a>
								...
								<div class="container">
									<ul class="navbar-nav pointer text-left" value="${trend}"
										...
										<li class="pt-2"><a id="keywordlink"
											style="color: #12bbad; font-family: NANUMBARUNPENR !important; font-size: 14px;">#${trend}</a></li>
									</ul>
								</div>
								<script>
			function trendsearch(e){   
				...
				<div class="pt-4 pb-3" style="font-size: 5px; margin-left: 20px;">
					<div class="container">
						<div class="row">
							<div class="col-md-10">
								<a href="footinfo.jsp"><p
										style="color: #212529; font-weight: bold;">
...
// 								}
	            		...
	            		divStr += "<div class='crecodiv pl-2 py-2 navbar-nav'>"
		            		divStr += "<div contenteditable=true class='creco ml-2 insertSpecialField'  id='comment" + boardSeq + "'>"
