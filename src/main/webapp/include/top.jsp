...
$(function() {    
 ...
 <span style="color: black;"></span>
                ...
                <ul class="navbar-nav">
                 ...
                 <li class="nav-item">
                  ...
                  <li class="nav-item">  
                    ...
                    <a class="nav-link dropdown-toggle fa-stack mb-2" href="#" id="alerticon" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"  >
          <i class="far fa-heart nav-icon" >
        </i> 
               	                    
        </a> 
          <!-- 알림 (하트,댓글) -->
      <span id="totalreadcount2" class="fa-stack mt-1" >   
    ...
    <i class="fab fas fa-bell text-white fa-stack-1x fa-inverse mt-1" style="font-size:13px;"><span id="countAlert" class="ml-1">5</span></i>
       ...
       <li id="modData" class="nav-item dropdown"> 
